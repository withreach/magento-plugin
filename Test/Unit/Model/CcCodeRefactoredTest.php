...
class CcCodeRefactoredTest extends TestCase
{
    ...
    /**
    @var \Magento\Payment\Model\Method\Cc |AbstractMethod  MockObject
     */
    ...
    protected function setUp()
    {
        ...
        //not getting extensively used at this point but will be ... shortly
        $this->request = [
            'MerchantId' => '12345',
            'ReferenceId' => 1,
            'Consumer' => null,
        ...
        */
        ...
        //for use in near future when we add more tests
    ...
    public function testAuthorize()
    {
        ...
        //important to have this to avoid getting null for cc->getInfoInstance inside authorize method in Model/Cc.php file
        $this->cc->setInfoInstance($this->info);
        ...
        $this->ccHelper->method('_buildCheckoutRequest')
            ->with($this->payment, $amount,  $this->reachHelper,
                $this->cc->getInfoInstance(), $this->reachCurrency)->willReturn($this->request)  ;
