...
class Cc extends \Magento\Payment\Model\Method\Cc
{
    ...
    */    
     ...
     * @param \Reach\Payment\Model\Currency $withCurrency
    ...
    public function __construct(
        ...
        \Reach\Payment\Model\Currency $withCurrency,
    ...
    public function void(\Magento\Payment\Model\InfoInterface $payment)
    {
        ...
        if(isset($response['OrderId']))
        {
            ...
            throw new \Magento\Framework\Exception\LocalizedException("Error during canceling authorization");
        }
        return $this;
    }
    ...
    */
    protected function _buildCheckoutRequest($payment, $amount)
    {
        ...
        $rateOfferId =  $this->withCurrency->getOfferId($order->getOrderCurrencyCode());
        if($rateOfferId)
        {
